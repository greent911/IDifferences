...
+(void)populateDatabase:(NSManagedObjectContext *)context
{
    ...
    NSString *excitingState = @"exciting";
...
//    [Seed insertDiffs:44.965813 topY:58.766674 downX:52.923073 downY:63.190674  diffFotos:T01A inContext:context];
    ...
    T02.uniqueID = @"T02";
    T02.available = avalable;
    DifferenceSet *T02A = [DifferenceSet createDifferenceFoto:@"T02A" forMaze:T02 inManagedObjectContext:context];
    ...
    T03.dificulty = detective;
    T03.state = normalState;
    T03.uniqueID = @"T03";
    T03.available = avalable;
    DifferenceSet *T03A = [DifferenceSet createDifferenceFoto:@"T03A" forMaze:T03 inManagedObjectContext:context];
    
    [Seed insertDiffs:32.011966 topY:18.413342 downX:42.078630 downY:26.092229  diffFotos:T03A inContext:context];
    [Seed insertDiffs:51.341879 topY:34.549343 downX:65.299141 downY:44.212456  diffFotos:T03A inContext:context];
    [Seed insertDiffs:40.965813 topY:82.766674 downX:57.923073 downY:95.190674  diffFotos:T03A inContext:context];
    [Seed insertDiffs:86.871796 topY:92.024672 downX:96.247864 downY:98.244896  diffFotos:T03A inContext:context];
    [Seed insertDiffs:46.065813 topY:34.066674 downX:51.333073 downY:39.190674  diffFotos:T03A inContext:context];
    
    Maze *T04 =[Maze createMaze:@"T04" forTheme:normal inManagedObjectContext:context];
    T04.dificulty = detective;
    T04.state = normalState;
    T04.uniqueID = @"T04";
    T04.available = avalable;
    DifferenceSet *T04A = [DifferenceSet createDifferenceFoto:@"T04A" forMaze:T04 inManagedObjectContext:context];
    
    [Seed insertDiffs:38.011966 topY:1.413342 downX:46.078630 downY:11.692229  diffFotos:T04A inContext:context];
    [Seed insertDiffs:51.341879 topY:38.549343 downX:65.299141 downY:51.212456  diffFotos:T04A inContext:context];
...
//    T05.uniqueID = @"C01";
//    T05.available = avalable;
//    DifferenceSet *T05A = [DifferenceSet createDifferenceFoto:@"C01A" forMaze:T05 inManagedObjectContext:context];
//    
//    [Seed insertDiffs:47.811966 topY:8.413342 downX:57.478630 downY:18.492229  diffFotos:T05A inContext:context];
//    [Seed insertDiffs:65.341879 topY:38.049343 downX:79.299141 downY:48.712456  diffFotos:T05A inContext:context];
//    [Seed insertDiffs:25.965813 topY:58.766674 downX:40.923073 downY:75.190674  diffFotos:T05A inContext:context];
//    [Seed insertDiffs:80.871796 topY:70.024672 downX:95.247864 downY:82.244896  diffFotos:T05A inContext:context];
//    [Seed insertDiffs:47.965813 topY:82.766674 downX:65.923073 downY:92.190674  diffFotos:T05A inContext:context];
//    
//    Maze *T06 =[Maze createMaze:@"C02" forTheme:normal inManagedObjectContext:context];
//    T06.dificulty = detective;
//    T06.state = normalState;
//    T06.uniqueID = @"C02";
//    T06.available = avalable;
//    DifferenceSet *T06A = [DifferenceSet createDifferenceFoto:@"C02A" forMaze:T06 inManagedObjectContext:context];
//    
//    [Seed insertDiffs:45.811966 topY:8.413342 downX:57.478630 downY:16.492229  diffFotos:T06A inContext:context];
//    [Seed insertDiffs:80.341879 topY:2.549343 downX:91.299141 downY:12.712456  diffFotos:T06A inContext:context];
//    [Seed insertDiffs:9.765813 topY:37.766674 downX:23.923073 downY:45.190674  diffFotos:T06A inContext:context];
//    [Seed insertDiffs:35.871796 topY:14.024672 downX:43.247864 downY:20.244896  diffFotos:T06A inContext:context];
//    [Seed insertDiffs:53.965813 topY:70.766674 downX:65.923073 downY:81.190674  diffFotos:T06A inContext:context];
//    
//    Maze *T07 =[Maze createMaze:@"C03" forTheme:normal inManagedObjectContext:context];
//    T07.dificulty = detective;
//    T07.state = normalState;
//    T07.uniqueID = @"C03";
//    T07.available = avalable;
//    DifferenceSet *T07A = [DifferenceSet createDifferenceFoto:@"C03A" forMaze:T07 inManagedObjectContext:context];
//    
//    [Seed insertDiffs:19.211966 topY:69.413342 downX:38.478630 downY:83.492229  diffFotos:T07A inContext:context];
//    [Seed insertDiffs:71.141879 topY:16.549343 downX:85.299141 downY:28.712456  diffFotos:T07A inContext:context];
//    [Seed insertDiffs:23.765813 topY:30.766674 downX:31.923073 downY:42.190674  diffFotos:T07A inContext:context];
//    [Seed insertDiffs:15.871796 topY:7.224672 downX:22.247864 downY:14.244896  diffFotos:T07A inContext:context];
//    [Seed insertDiffs:64.965813 topY:76.766674 downX:79.523073 downY:85.190674  diffFotos:T07A inContext:context];
    /***********************************************************************************************************************************************************************
     *
     *
     *                                               STATE - exciting
    ...
    Maze *eT02 =[Maze createMaze:@"eT02" forTheme:normal inManagedObjectContext:context];
    eT02.dificulty = detective;
    eT02.state = excitingState;
    eT02.uniqueID = @"eT02";
    eT02.available = avalable;
    DifferenceSet *eT02A = [DifferenceSet createDifferenceFoto:@"eT02A" forMaze:eT02 inManagedObjectContext:context];
    
    [Seed insertDiffs:11.011966 topY:4.413342 downX:21.078630 downY:11.092229  diffFotos:eT02A inContext:context];
    [Seed insertDiffs:24.341879 topY:15.049343 downX:42.299141 downY:19.712456  diffFotos:eT02A inContext:context];
    [Seed insertDiffs:52.965813 topY:65.766674 downX:64.923073 downY:77.190674  diffFotos:eT02A inContext:context];
    [Seed insertDiffs:63.871796 topY:51.024672 downX:70.247864 downY:57.244896  diffFotos:eT02A inContext:context];
    [Seed insertDiffs:90.065813 topY:0.066674 downX:99.923073 downY:52.190674  diffFotos:eT02A inContext:context];
    
    Maze *eT03 =[Maze createMaze:@"eT03" forTheme:normal inManagedObjectContext:context];
    eT03.dificulty = detective;
    eT03.state = excitingState;
    eT03.uniqueID = @"eT03";
    eT03.available = avalable;
    DifferenceSet *eT03A = [DifferenceSet createDifferenceFoto:@"eT03A" forMaze:eT03 inManagedObjectContext:context];
    
    [Seed insertDiffs:32.011966 topY:18.413342 downX:42.078630 downY:26.092229  diffFotos:eT03A inContext:context];
    [Seed insertDiffs:51.341879 topY:34.549343 downX:65.299141 downY:44.212456  diffFotos:eT03A inContext:context];
    [Seed insertDiffs:40.965813 topY:82.766674 downX:57.923073 downY:95.190674  diffFotos:eT03A inContext:context];
    [Seed insertDiffs:86.871796 topY:92.024672 downX:96.247864 downY:98.244896  diffFotos:eT03A inContext:context];
    [Seed insertDiffs:46.065813 topY:34.066674 downX:51.333073 downY:39.190674  diffFotos:eT03A inContext:context];
    
    Maze *eT04 =[Maze createMaze:@"eT04" forTheme:normal inManagedObjectContext:context];
    eT04.dificulty = detective;
    eT04.state = excitingState;
    eT04.uniqueID = @"eT04";
    eT04.available = avalable;
    DifferenceSet *eT04A = [DifferenceSet createDifferenceFoto:@"eT04A" forMaze:eT04 inManagedObjectContext:context];
    
    [Seed insertDiffs:38.011966 topY:1.413342 downX:46.078630 downY:11.692229  diffFotos:eT04A inContext:context];
    [Seed insertDiffs:51.341879 topY:38.549343 downX:65.299141 downY:51.212456  diffFotos:eT04A inContext:context];
    ...
    DifferenceSet *C01A = [DifferenceSet createDifferenceFoto:@"C01A" forMaze:C01 inManagedObjectContext:context];
    ...
    DifferenceSet *C02A = [DifferenceSet createDifferenceFoto:@"C02A" forMaze:C02 inManagedObjectContext:context];
    ...
    Maze *C03 =[Maze createMaze:@"C03" forTheme:normal inManagedObjectContext:context];
    C03.dificulty = detective;
    C03.state = challengeState;
    C03.uniqueID = @"C03";
    C03.available = avalable;
    DifferenceSet *C03A = [DifferenceSet createDifferenceFoto:@"C03A" forMaze:C03 inManagedObjectContext:context];
    
    [Seed insertDiffs:19.211966 topY:69.413342 downX:38.478630 downY:83.492229  diffFotos:C03A inContext:context];
    [Seed insertDiffs:71.141879 topY:16.549343 downX:85.299141 downY:28.712456  diffFotos:C03A inContext:context];
    [Seed insertDiffs:23.765813 topY:30.766674 downX:31.923073 downY:42.190674  diffFotos:C03A inContext:context];
    [Seed insertDiffs:15.871796 topY:7.224672 downX:22.247864 downY:14.244896  diffFotos:C03A inContext:context];
    [Seed insertDiffs:64.965813 topY:76.766674 downX:79.523073 downY:85.190674  diffFotos:C03A inContext:context];
